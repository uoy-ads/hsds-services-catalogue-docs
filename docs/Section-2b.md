...
![Service Provider login link](assets/service_provider_login.jpg){ width="650" }
<p align=center><i></i></p>

Login uses the same credentials (email address and password) as UMA.

![Login page](assets/catalogue-login.png){ width="650" }
<p align=center><i></i></p>
